...
if(1)
{
    ...
    $Owner_Password=$_SESSION['Owner_Password'];
    
    $sql="select Owner_First_Name, Owner_Last_Name, Owner_Email_ID, Owner_Aadhar_Number, Owner_PAN_Number, Owner_Mobile_Number from owner_registration where Owner_Aadhar_Number='$Owner_Aadhar_Number' and Owner_Password='$Owner_Password'";
       ...
       if($conn->connect_error)
        ...
        else
        {
          while($row = mysqli_fetch_assoc($result))
          {
            ...
            echo '<b>Name:  </b>'.$row['Owner_First_Name'].'&nbsp&nbsp&nbsp'.$row['Owner_Last_Name'].'<br>';
    
            echo '<b>Email-ID: </b>'.$row['Owner_Email_ID'].'<br>';
    
            echo '<b>Aadhar Number: </b>'.$row['Owner_Aadhar_Number'].'<br>';
    
            echo '<b>PAN Number: </b>'.$row['Owner_PAN_Number'].'<br>';
  ...
  <table class="table table-bordered">
    <thead>
      ...
      <tr>
        ...
        <div class="Owner_logout">
          <a href="rental_index.html"> <input type="submit" name="Logout" value="Logout"></a>
        </div>
